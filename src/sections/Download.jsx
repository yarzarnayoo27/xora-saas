              ...
              <ul className="flex items-center gap-6">
                {links.map(({ id, url, icon }) => (
                  ...
                  >
                    <a
                      href={url}
                      className="size-22 download_tech-icon_before relative flex justify-center items-center rounded-half border-2 border-s3 bg-s1 transition-borderColor duration-500"
                    >
